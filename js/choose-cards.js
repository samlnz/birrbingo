...
class ChooseCardsPage {
    ...
    if (this.gameState.selectedCards.length > 0) {
        ...
        // Don't auto-select - let player choose or use random button
        BingoUtils.showNotification('Please select cards or use Random Selection button', 'warning');
        // Restart timer for 10 more seconds
