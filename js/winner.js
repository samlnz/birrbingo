...
class WinnerPage {
    ...
    displayWinnerInfo() {
        ...
        // Calculate winnings
        const basePrize = 250; // First line
        const additionalLines = Math.max(0, this.winnerData.totalLines - 1);
        const additionalPrize = additionalLines * 50;
        const totalWinnings = basePrize + additionalPrize;
        
        this.yourWinnings.textContent = `$${totalWinnings}`;
